            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    FacilityWidget(
                        assetPath: AppImages.wifiIcon, title: 'Free Wifi'),
                    FacilityWidget(
                ...
                const ContactRowWidget(
                    icon: Icons.phone, text: '(+225) 22-40-20-26'),
                SizedBox(height: Sizes.xs),
                const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ContactRowWidget(
                        icon: Icons.access_time, text: 'Check-In 12 PM'),
                    ContactRowWidget(
                ...
                SizedBox(height: Sizes.size15),
                SectionTitle(
                    title: 'CHECK AVAILABILITY', color: AppColors.black),
                SizedBox(height: Sizes.size15),
                CustomDatePicker(
